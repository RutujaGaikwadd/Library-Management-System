	...
	<div class="header">
		<div class="container">
			<div class="row">
				<div class="col-3">
					<div class="logo">
						<img src="dist/img/l.png" alt="logo">
					</div>
				</div>
				<div class="col-9">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="right">
						<h3>Contact Info</h3>
						<p>Feel free to contact if you are facing any issue or query.</p>

						<div class="box">
							<p><i class="fas fa-home"></i><span> Sai Simran Park B-3, Pimpri, Pune -17</span></p>
							<p><i class="far fa-envelope"></i><span> g.rutuja2001@gmail.com</span></p>
							<p><i class="fas fa-phone"></i><span> (+91)9960445529</span></p>
							<p>(+91)7798252002</p>
						</div>
					</div>
				</div>
